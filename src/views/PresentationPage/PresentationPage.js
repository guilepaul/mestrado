...
export default function PresentationPage() {
  ...
  return (
    <div>
      ...
      />
      <Parallax
        image={require("assets/img/lake2.jpeg")}
          ...
          <GridContainer>
            <GridItem>
              <div className={classes.brand}>
                <h1>
                  Uso da água na produção animal:
                </h1>
                {/* <h1>
                  
                <span className={classes.proBadge}>Produtividade Hídrica e Escassez Hídrica</span>
                </h1> */}
                <h3 className={classes.title}>
                Produtividade Hídrica e Escassez Hídrica
                </h3>
              </div>
            </GridItem>
          </GridContainer>
